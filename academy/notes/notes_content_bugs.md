...
- **Navigation Components:** Linking problems in the navigation menu, header, footer, or breadcrumbs are typically **LOW** functional bugs.
- **Exception:** It remains a content problem if the functionality is easily/intuitively reachable via a different path.
